...
public class HcpsupportTopGuidelineNavigation {
	public static void main(String[] args) {
		...
		String url = "https://" + username + ":" + password + "@mci-jp-preview.epublishmerck.com/hcpsupport/top/guideline.xhtml";
		String expectedUrl = "https://mci-jp-preview.epublishmerck.com/registered/hcpsupport/top/guideline.xhtml";
		driver.get(url);
