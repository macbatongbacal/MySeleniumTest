...
public class HcpsupportTopEdtlNavigation {
	public static void main(String[] args) {
		...
		String url = "https://" + username + ":" + password + "@mci-jp-preview.epublishmerck.com/hcpsupport/top/edtl.xhtml";
		String expectedUrl = "https://mci-jp-preview.epublishmerck.com/registered/hcpsupport/top/edtl.xhtml";
		driver.get(url);
